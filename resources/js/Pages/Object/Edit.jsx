...
// import usefileUpd from '@/Hooks/usefileUpd';
...
export default function Dashboard({auth, objectItem}) {
    ...
    const handlePhotoUpload = (item) => {
        setUploadedPhoto(item);
    };
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        ...
                                        <div className="col-span-full">
                                            ...
                                            <p className="mt-3 text-sm leading-6 text-gray-600">Write a few sentences
                                                about yourself.</p>
                                        </div>
                                            ...
                                            <div
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    {/*</div>*/}
                                                        ...
                                                        <FileUpload  onPhotoUPload={handlePhotoUpload} />
